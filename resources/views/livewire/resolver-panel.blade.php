...
>
    <div x-show="open" class="flex flex-row ">
        ...
        >
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.1" stroke="currentColor" class="w-6 h-6 hover:scale-110">
        ...
        >
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" class="w-6 h-6 hover:scale-110">
    ...
    >
        <button class="rounded-full bg-slate-800 text-white mr-2 justify-center text-center hover:scale-110">
