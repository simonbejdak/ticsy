<a
    ...
    <div class="flex flex-row justify-between pl-4 pr-2 py-1 border-t border-gray-700 hover:cursor-pointer transition ease-in duration-75 group">
        ...
        <div wire:click.prevent="starClicked" class="{{ $favorite ? '' : 'hidden group-hover:block transition ease-in duration-75 text-gray-200' }}">
            <svg
                viewBox="0 0 24 24"
                stroke="currentColor"
                class="fill-none w-5 h-5 hover:scale-110"
            >
